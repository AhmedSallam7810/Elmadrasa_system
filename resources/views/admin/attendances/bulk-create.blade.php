...
@section('title', 'Bulk Record Attendance')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Record Attendance for {{ $class->name }}</h3>
                                ...
                                <tbody>
                                    @foreach($class->students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="attendances[{{ $loop->index }}][notes]" placeholder="Optional notes">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
