...
$(document).ready(function() {
    ...
    function updateBehaviorTable() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#behavior-table').html(response);
            },
            error: function() {
                $('#behavior-table').html('<div class="alert alert-danger"><i class="fas fa-exclamation-triangle mr-2"></i>Error loading behavior records.</div>');
            }
        });
    }
    ...
    $('#clear_filters').on('click', function() {
        $('#class_filter, #status_filter').val('').trigger('change');
